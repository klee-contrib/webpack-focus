...
import { configBuilder, serverLauncher } from './index';
...
const LEGACY_SEARCH_API = process.env.LEGACY_SEARCH_API ? JSON.parse(process.env.LEGACY_SEARCH_API) : false;
...
serverLauncher(configBuilder(customConfig, globals), { proxy: null });
