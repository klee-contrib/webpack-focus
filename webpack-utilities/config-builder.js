...
var ConfigBuilder = function () {
    ...
    ConfigBuilder.prototype._getElement = function _getElement(orderedList, eltOrdre) {
    ...
    ConfigBuilder.prototype._getIndexElement = function _getIndexElement(orderedList, eltOrdre) {
    ...
    ConfigBuilder.prototype._removeElt = function _removeElt(orderedList, ordre) {
    ...
    ConfigBuilder.prototype.removePlugin = function removePlugin(ordre) {
    ...
    ConfigBuilder.prototype.getPlugin = function getPlugin(ordre) {
    ...
    ConfigBuilder.prototype.removeLoader = function removeLoader(ordre) {
    ...
    ConfigBuilder.prototype.getLoader = function getLoader(ordre) {
